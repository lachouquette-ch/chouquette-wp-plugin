...
class Chouquette_WP_Plugin
{
	...
	private function define_rest_hooks()
	{
		...
		$this->loader->add_filter('rest_fiche_query', $plugin_rest, 'fiche_chouquettise_filter_and_sort', 10, 2);
		...
		$this->loader->add_action('rest_prepare_category', $plugin_rest, 'category_logo_links', 10, 1);

		$this->loader->add_action('rest_prepare_cq_values', $plugin_rest, 'value_icon_link', 10, 1);
		...
		$this->loader->add_action('rest_api_init', $plugin_rest, 'value_icon');
